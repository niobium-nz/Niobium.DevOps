...
output blobFQDN string = replace(storageAccount.properties.primaryEndpoints.blob, 'https://', '')
output tableFQDN string = replace(storageAccount.properties.primaryEndpoints.table, 'https://', '')
output queueFQDN string = replace(storageAccount.properties.primaryEndpoints.queue, 'https://', '')
